...
function redirectToCheckout(plan, event) {
  ...
  const planName = isCompleto 
    ? 'Plano Completo (R$ 37) - Atlas Visual da Ultrassonografia Clínica' 
    : (isUpgrade 
        ? 'Plano Premium Upgrade (R$ 30) - Atlas Visual da Ultrassonografia Clínica' 
        : (isDownsell 
            ? 'Plano Essencial / Downsell (R$ 19) - Atlas Visual da Ultrassonografia Clínica' 
            : 'Plano Básico (R$ 27) - Atlas Visual da Ultrassonografia Clínica'));
